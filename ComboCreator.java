...
public class ComboCreator extends SwingWorker<Void,Void> {
	...
	public ComboCreator(String video, String name, AudioSetting setting) {
	...
	protected Void doInBackground() throws Exception {
		...
		if(setting == AudioSetting.REPLACE) {
			...
			cmd = "text2wave .PetulantWaffle/Speech.txt -o .PetulantWaffle/speech.wav;"
					...
					+"ffmpeg -i .PetulantWaffle/video.mp3 -i .PetulantWaffle/audio.mp3 "
					+ "-filter_complex amix=inputs=2:duration=first:dropout_transition=3 -y .PetulantWaffle/audiofinal.mp3;"
